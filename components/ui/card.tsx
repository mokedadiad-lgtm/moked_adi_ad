...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("text-start font-semibold leading-none tracking-tight text-primary", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-start text-sm text-secondary", className)} {...props} />
));
